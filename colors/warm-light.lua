...
local blue     = "#4D55A0"
local tan      = "#705942"
local keyword  = "#914A1A"
local diff_bg  = "#C5DDE9"
local diff_del = "#E3BEB7"
local diff_chg = "#E2E0E8"
local diff_fg  = "#266385"
local context  = cursorline
...
hl("Normal",        { fg = fg })
hl("NormalNC",      {})
hl("NormalFloat",   { fg = fg, bg = cursorline })
hl("FloatBorder",   { fg = orange, bg = cursorline })
